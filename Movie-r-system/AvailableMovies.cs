...
namespace Movie_r_system
{
    ...
    public partial class AvailableMovies : Form
    {
        ...
        private void AvailableMovies_Load(object sender, EventArgs e)
        {
            string query = "SELECT * FROM Movie where Available = 'True'";
